    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
         <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>id_elem</ogc:PropertyName>
              <ogc:Literal>182</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>1067</se:MinScaleDenominator>
          <se:MaxScaleDenominator>4600</se:MaxScaleDenominator>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:MaxScaleDenominator>1066</se:MaxScaleDenominator>
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#f8f8f8</se:SvgParameter>
