  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <!-- Etiquetas de Texto (Rango 4500 - 8500) - Regla 000 -->
        <se:Rule>
          <se:Name>000</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <!-- Etiquetas de Texto (Rango 4500 - 8500) - Regla 500 -->
        <se:Rule>
          <se:Name>500</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <!-- ========================================== -->
               ...
               <se:Rule>
          <se:Name>1000 500_punto</se:Name>
          <se:Description>
            <se:Title>Puntos Lejanos (500/1000 Alt)</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
        ...
        <!-- Puntos Cercanos - Centenas y 50s -->
        <se:Rule>
